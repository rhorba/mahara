...
export function LoginForm() {
  ...
  return (
    <div className="mx-auto w-full max-w-sm">
      <h1 className="mb-6 text-center text-2xl font-bold text-mahara-green">{t("login_title")}</h1>
      ...
      <p className="mt-6 text-center text-sm text-gray-500">
        {t("not_member")}{" "}
        <Link href="/auth/signup" className="font-medium text-mahara-green hover:underline">
          {t("signup_title")}
        </Link>
      </p>
    </div>
