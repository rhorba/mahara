...
export const createGig = withRole(["business"], gigSchema, async ({ tx, userId, input }) => {
...
export const updateGig = withRole(["business"], updateGigSchema, async ({ tx, userId, input }) => {
